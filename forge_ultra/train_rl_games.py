...
class ForgeUltraRlGamesGpuEnv(RlGamesGpuEnv):
    def set_train_info(self, env_frames, *args, **kwargs):
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: dict):
    ...
    env = ForgeUltraRlGamesVecEnvWrapper(env, rl_device, clip_obs, clip_actions)

    vecenv.register("IsaacRlgWrapper", lambda config_name, num_actors, **kwargs: ForgeUltraRlGamesGpuEnv(config_name, num_actors, **kwargs))
